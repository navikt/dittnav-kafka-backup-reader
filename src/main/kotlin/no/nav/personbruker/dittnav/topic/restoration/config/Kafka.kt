...
import no.nav.personbruker.dittnav.topic.restoration.config.ConfigUtil.isCurrentlyRunningOnNais
...
object Kafka {
    ...
    val transactionIdName = "dittnav-kafka-backup-reader-transaction"
